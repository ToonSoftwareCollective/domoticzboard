...
Item {
	...
	QtObject {
		...
		property DomoticzThreeStateButton prvButUp: butUp
		property DomoticzThreeStateButton prvButDown: butDown
		...
		function updateButtons() {
			...
			//had to do manual setting of visible property of buttons here because there is a problem with icon in DomoticzThreeStateButton when directly bound
		...
		function updateScrollbar() {
			...
			scrollbar.height = Math.floor(domoticzMarkup.height / pageCount);
			...
			topMargin = (topMargin + scrollbar.height) >= domoticzMarkup.height ? domoticzMarkup.height - scrollbar.height - 1 : topMargin;
	...
	DomoticzThreeStateButton {
		id: butDown
		width: 38
		height: domoticzMarkup.height / 2
		...
		anchors {
			bottom: domoticzMarkup.bottom
			left: domoticzMarkup.right
